namespace PGB.WPF.Models
{
    ...
    internal class MainWindowModel : ISettings
    {
        ...
        public MainWindowModel()
        {
            ...
            PokemonsToCatch = new List<PokemonId>();
            PokemonsToEvolve = new List<PokemonId>();
            PokemonsToTransfer = new List<PokemonId>();
        ...
        private readonly string gpxFile = string.Empty;
        ...
        public GMapProvider GMapProvider => (GMapProvider) GoogleMapProvider.Instance;
        ...
        public List<KeyValuePair<ItemId, int>> ItemRecycleFilter
            => new List<KeyValuePair<ItemId, int>>(new KeyValuePair<ItemId, int>[30]
            {
        ...
        public string GPXFile
        {
            ...
            set
            {
                ...
                var source = (fileName != null ? fileName.SanitizeFileName() : null) ?? string.Empty;
                if (!string.IsNullOrEmpty(source) && !source.TrimEnd().EndsWith(".gpx"))
                {
                    source += ".gpx";
                }
            }
        ...
        [IgnoreAutoChangeNotification]
        List<KeyValuePair<ItemId, int>> ISettings.ItemRecycleFilter
        {
